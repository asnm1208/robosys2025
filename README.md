...
- 範囲外の日付    : `invalid date`  
- フォーマット不正: `ERROR: 入力は 'YYYY M D' の形式で指定してください`  
- 数字以外の入力  : `ERROR: 年/月/日は整数で指定してください`
- 入力なし        : `invalid input`
...
- 本[README](https://github.com/asnm1208/robosys2025/blob/main/README.md)は、[akajaika](https://github.com/akajaika)の[robosys2024](https://github.com/akajaika/robosys2024/blob/main/README.md)(© 2024 Kai Nonaka)を参考に作られています。
- © 2025 asnm1208
